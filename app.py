...
# ============================================================
# CARDS DE ROI USANDO st.components.v1.html
# ============================================================
...
for nome, capital in perfis:
    ...
    <div class="roi-card">
        ...
        <p class="section-title">Cenário Conservador</p>
        <p>Ações (4%): <strong>R$ {conserv_acao:,.0f}</strong></p>
        <p>Opções (12%): <strong>R$ {conserv_opc:,.0f}</strong></p>

        <hr>

        <p class="section-title">Premissas da Estratégia</p>
        <p>Ações (6%): <strong>R$ {estrat_acao:,.0f}</strong></p>
        <p>Opções (25%): <strong>R$ {estrat_opc:,.0f}</strong></p>
    </div>
    """
    cards.append(card)
...
<style>
  ...
  .roi-card {
    ...
    border-radius: 18px;
    border: 1px solid rgba(0,255,154,0.25);
    box-shadow: 0 0 18px rgba(0,255,154,0.25);
