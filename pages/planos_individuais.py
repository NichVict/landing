...
<div class='grid'>
    ...
    <div class='plan-card-wrapper'>
        ...
        <h3>Small Caps</h3>
        <p>Empresas em crescimento acelerado com maior potencial de valorização.</p>
        <div class='price'>R$ 164/mês</div>
        <p style='font-size:0.8rem; color:#bfbfbf;'>
            Cobrado anualmente · Mensal R$ 219 · Trimestral R$ 193
        </p>
        <div class='assinatura-btn'>
            <a href='https://wa.me/351915323219' target='_blank'>Assinar</a>
        </div>
    ...
    <div class='plan-card-wrapper'>
        ...
        <h3>Carteira BDR</h3>
        <p>Exposição a empresas globais com simplicidade e diversificação cambial.</p>
        <div class='price'>R$ 164/mês</div>
        <p style='font-size:0.8rem; color:#bfbfbf;'>
            Cobrado anualmente · Mensal R$ 219 · Trimestral R$ 193
        </p>
    ...
    <div class='plan-card-wrapper'>
        ...
        <p>Estratégias com opções focadas em assimetria e volatilidade.</p>
        <div class='price'>R$ 223/mês</div>
        <p style='font-size:0.8rem; color:#bfbfbf;'>
            Cobrado anualmente · Mensal R$ 297 · Trimestral R$ 261
        </p>
        <div class='assinatura-btn'>
            <a href='https://wa.me/351915323219' target='_blank'>Assinar</a>
        </div>
