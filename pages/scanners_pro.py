...
<div class="features">
    ...
    <div>Ambos Scanners têm um Score com as Top oportunidades e entregam as estratégias prontas, com gatilhos de entrada, stop loss e gain.</div>
    <div>Registro técnico e visual de todas as buscas, para consulta e geração de relatórios. </div>    
    <div>✔️ Plataforma profissional em tempo real</div>
    <div>✔️ Ferramenta de apoio à decisão</div>
